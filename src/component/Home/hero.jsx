...
const Hero = () => {
  return (
    <div
      className="w-full min-h-[90vh] px-4 py-6 xs:px-5 sm:px-6 md:px-8 lg:px-10 xl:px-20 2xl:px-40 
                 flex flex-col lg:flex-row items-center bg-white overflow-hidden"
    >
      {/* ---------- CONTENT SECTION ---------- */}
      <div
        className="w-full lg:w-[55%] bg-white min-h-[500px] lg:h-[540px] 
                   flex flex-col justify-center gap-4 lg:gap-7 
                   pr-2 xs:pr-5 sm:pr-6 lg:pr-12 
                   rounded-tr-[50px] lg:rounded-tr-[100px] 
      ...
      >
        {/* Main Heading */}
        <h1
          className="text-3xl xs:text-3xl sm:text-3xl md:text-4xl lg:text-5xl 
                     font-bold text-primary leading-tight 
                     mt-5 sm:mt-0 w-full sm:w-[600px]"
        >
          Your Digital <span className="text-secondary">Success</span> Partner
          ...
          <a href="/services">
            <button
              className="w-full sm:w-auto flex items-center justify-center gap-2 
                         px-4 sm:px-6 py-3 font-semibold rounded-md 
      ...
      {/* ---------- IMAGE SECTION ---------- */}
      <div
        className="overflow-hidden w-full lg:w-[65%] -mt-6 lg:mt-0 xl:-ml-52 
                   flex justify-center lg:justify-start order-1 lg:order-2"
      >
        <img
          src={hero}
          alt="Digital Career Agency Services"
          className="w-full max-w-[800px] lg:max-w-none 
                     xs:max-w-[440px] sm:max-w-[520px] md:max-w-full md:h-[300px] 
                     lg:w-[400px] lg:h-[600px] xl:w-full xl:h-auto 
                     h-auto object-cover rounded-bl-[140px] lg:rounded-bl-none"
        />
      </div>
    </div>
  );
