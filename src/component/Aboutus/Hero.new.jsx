        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              To unlock digital career opportunities for freelancers, students,
              and businesses by providing the right tools, resources, and
              guidance. We aim to help people earn, grow, and thrive online
              through freelancing and digital skills.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-gray-600">
                Starting their freelancing journey
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg leading-relaxed mb-8">
              We envision a future where every individual in Pakistan and beyond
              has access to global opportunities through freelancing and digital
              skills. By nurturing young talent and providing them with the
              right direction, we aim to become a leading agency in digital
        ...
        <div className="container mx-auto">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-700 mb-4">
              Want to learn more about our services or discuss how we can help
              you?
            </p>
            <Link
              to="/contact"
